...
const GRADIENT_COLORS = [
  'from-gray-950/10 to-gray-500/5',
  ...
  'from-gray-500/10 to-gray-950/5',
];
  ...
  return (
    <motion.div
      className={classNames(
        ...
        gradientClass,
        borderEffect
          ? 'border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark hover:border-black dark:border-gray-500/40'
          : '',
