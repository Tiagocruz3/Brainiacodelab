  ...
  return (
    <motion.div
      ...
      className={classNames(
        ...
        active
          ? 'bg-black dark:bg-gray-500/15 text-black dark:text-gray-600 dark:text-black dark:text-gray-400 border border-black dark:border-gray-500/30'
      ...
      <span>
        ...
        {value !== undefined && (
          <span
            className={
              active
                ? 'text-black dark:text-gray-700 dark:text-black dark:text-gray-300 font-semibold'
      ...
      {onRemove && (
        <button
          ...
          className={classNames(
            ...
            active
              ? 'text-black dark:text-gray-600 dark:text-black dark:text-gray-400'
