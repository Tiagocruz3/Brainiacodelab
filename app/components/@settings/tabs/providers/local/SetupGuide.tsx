...
function SetupGuide({ onBack }: { onBack: () => void }) {
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-black/10 dark:to-gray-500/10 border border-blue-500/20 shadow-sm">
        <CardContent className="p-6">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Monitor className="w-4 h-4 text-black dark:text-gray-500" />
      ...
      <Card className="bg-bolt-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-black/10 dark:from-gray-500/20 to-black/10 dark:to-gray-600/20 flex items-center justify-center ring-1 ring-black dark:ring-gray-500/30">
              <Server className="w-6 h-6 text-black dark:text-gray-500" />
            </div>
            ...
            <span className="px-3 py-1 bg-black dark:bg-gray-500/10 text-black dark:text-gray-500 text-xs font-medium rounded-full">
              Recommended
            </span>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-bolt-elements-background-depth-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full bg-gradient-to-r from-black/10 dark:from-gray-500/10 to-black/10 dark:to-gray-600/10 hover:from-black/10 dark:from-gray-500/20 hover:to-black/10 dark:to-gray-600/20 border-black dark:border-gray-500/30 hover:border-black dark:border-gray-500/50 transition-all duration-300 gap-2 group shadow-sm hover:shadow-lg hover:shadow-black/10 dark:shadow-gray-500/20 font-medium"
                    _asChild
                  >
                    <a
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-black dark:bg-gray-500/5 border border-black dark:border-gray-500/20">
                <div className="flex items-center gap-2 mb-2">
                  <Activity className="w-4 h-4 text-black dark:text-gray-500" />
                  <span className="font-medium text-black dark:text-gray-500">Performance Optimized</span>
                </div>
      ...
      <Card className="bg-gradient-to-r from-black/10 dark:from-gray-500/10 to-blue-500/10 border border-black dark:border-gray-500/20 shadow-sm">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-black dark:bg-gray-500/20 flex items-center justify-center">
              <Activity className="w-5 h-5 text-black dark:text-gray-500" />
            </div>
            <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 rounded-lg bg-bolt-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Cable className="w-4 h-4 text-black dark:text-gray-500" />
